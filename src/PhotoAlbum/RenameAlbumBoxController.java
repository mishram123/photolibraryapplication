...
public class RenameAlbumBoxController {
  @FXML
  ...
  public RenameAlbumBoxController(){
    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("renameAlbumBox.fxml"));
  ...
  public void initialize(){
    okButton.setOnAction(event -> renameAlbum(event));
